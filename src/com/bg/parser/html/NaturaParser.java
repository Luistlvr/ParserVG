 ...
 * @author luis
 */
public class NaturaParser implements Parser {
            ...
            for(Node item : items) {
                ...
                for(Node category : categories) {
                    ...
                    print("Titulo: %s\nDescripcion: %s\nProducts:", 
                            ...
                            category.attr("title"));
                    getElements(category.attr(NaturaGlobals.ABS_LINK));
                }
                System.out.println("\n");
            }
    ...
    @Override
    public void getElements(String url_galery) {
        try {
            ...
            for(Element item : galery) {
                getElement(item.child(0).child(0).attr(NaturaGlobals.ABS_LINK));
            }
    ...
    @Override
    public void getElement(String url_product) {
        try {
